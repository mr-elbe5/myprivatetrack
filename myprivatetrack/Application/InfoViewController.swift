...
class InfoViewController: ScrollViewController {
    ...
    override func loadView() {
        ...
        timelineStackView.addArrangedSubview(InfoText(text: "timelineLocationInfo".localize()))
        ...
        timelineStackView.addArrangedSubview(InfoHeader(text: "editEntryItemInfoHeader".localize(), paddingTop: 2 * Insets.defaultInset))
        timelineStackView.addArrangedSubview(IconInfoText(icon: "trash", text: "editEntryDeleteIconInfo".localize(),iconColor: .systemRed))
        timelineStackView.addArrangedSubview(IconInfoText(icon: "magnifyingglass", text: "timelineDetailIconInfo".localize()))
        timelineStackView.addArrangedSubview(IconInfoText(icon: "square.and.arrow.up", text: "timelineShareIconInfo".localize()))
        timelineStackView.addArrangedSubview(InfoHeader(text: "timelineEntryInfoHeader".localize(), paddingTop: 2 * Insets.defaultInset))
        timelineStackView.addArrangedSubview(InfoHeader(text: "timelineInfoEditHeader".localize(), paddingTop: 2 * Insets.defaultInset))
        timelineStackView.addArrangedSubview(InfoText(text: "timelineEditInfo".localize()))
        ...
        entryStackView.addArrangedSubview(IconInfoText(icon: "text.bubble", text: "timelineTextIconInfo".localize()))
        entryStackView.addArrangedSubview(IconInfoText(icon: "camera", text: "timelinePhotoIconInfo".localize()))
        entryStackView.addArrangedSubview(IconInfoText(icon: "photo", text: "timelineImageIconInfo".localize()))
        entryStackView.addArrangedSubview(IconInfoText(icon: "mic", text: "timelineAudioIconInfo".localize()))
        entryStackView.addArrangedSubview(IconInfoText(icon: "video", text: "timelineVideoIconInfo".localize()))
