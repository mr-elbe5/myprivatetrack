...
class MainTabController: UITabBarController {
    ...
    override func loadView() {
        ...
        let mapViewController = EntriesMapViewController()
    ...
    static func getMapViewController() -> EntriesMapViewController?{
        return getViewController(tag: .map) as! EntriesMapViewController?
    }
